...
ball1=BouncingBall(350,250,L,L,30)
ball2=BouncingBall(300,200,L,L,25)
ball3=BouncingBall(250,150,L,L,35)
...
while not done:
    ...
    #ball1
    ball1.flashBounce(screen,GREY,700,500)

    #ball2
    ball2.flashBounce(screen,GREY,700,500)

    #ball3
    ball3.flashBounce(screen,GREY,700,500)
